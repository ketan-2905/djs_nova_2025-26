...
import { Calendar, MapPin, Clock, Users, X, ChevronLeft, ChevronRight, ExternalLink } from 'lucide-react';
...
const eventsData: Event[] = [
  {
    ...
    description: 'Join us for an incredible journey through the latest advancements in space technology. This summit brings together industry leaders, researchers, and enthusiasts to explore the future of space exploration.',
    date: '2025-11-15',
    ...
    gallery: [
      { url: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800', alt: 'Space Tech Summit' },
      { url: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800', alt: 'Technology Display' },
      { url: 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=800', alt: 'Keynote Speaker' },
      { url: 'https://images.unsplash.com/photo-1464802686167-b939a6910659?w=800', alt: 'Audience View' }
    ],
    details: {
    ...
    testimonials: [
      {
        ...
        role: 'ISRO Scientist',
        comment: 'An exceptional event that showcased the future of space technology. The presentations were insightful and inspiring.',
  ...
  },
  {
    ...
    description: 'Explore how artificial intelligence is revolutionizing astronomical research and space exploration.',
    date: '2025-12-01',
    ...
    gallery: [
      { url: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800', alt: 'AI Workshop' },
      { url: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800', alt: 'Workshop Session' }
    ],
    details: {
  ...
  },
  {
    ...
    description: 'A memorable evening under the stars where participants observed celestial objects through telescopes and learned about constellations.',
    date: '2024-10-20',
    time: '7:00 PM - 11:00 PM',
    location: 'College Terrace',
    attendees: 200,
    status: 'past',
    coverImage: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=1200&h=600&fit=crop',
    gallery: [
      { url: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=800', alt: 'Stargazing' },
      { url: 'https://images.unsplash.com/photo-1464802686167-b939a6910659?w=800', alt: 'Night Sky' },
      { url: 'https://images.unsplash.com/photo-1446941611757-91d2c3bd3d45?w=800', alt: 'Telescope View' }
    ],
    details: {
      organizer: 'DJS Nova Space Committee',
    ...
    testimonials: [
      {
        ...
        comment: 'An unforgettable experience! Seeing Jupiter and its moons through the telescope was absolutely breathtaking.',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Priya'
      },
      {
        name: 'Arjun Mehta',
        role: 'Third Year Student',
        comment: 'The organizers did an excellent job explaining the constellations. Looking forward to more events like this!',
  ...
  },
  {
    ...
    description: 'An engaging seminar on rocket propulsion systems and the physics behind space travel.',
    date: '2024-09-15',
    time: '3:00 PM - 6:00 PM',
    location: 'Seminar Hall A',
    attendees: 180,
    status: 'past',
    coverImage: 'https://images.unsplash.com/photo-1516849841032-87cbac4d88f7?w=1200&h=600&fit=crop',
    gallery: [
      { url: 'https://images.unsplash.com/photo-1516849841032-87cbac4d88f7?w=800', alt: 'Rocket Launch' },
      { url: 'https://images.unsplash.com/photo-1581822261290-991b38693d1b?w=800', alt: 'Seminar Session' }
    ],
    details: {
  ...
  },
  {
    ...
    description: 'A stunning collection of astrophotography captured by students and professionals.',
    date: '2024-08-10',
    time: '10:00 AM - 8:00 PM',
    location: 'College Gallery',
    attendees: 300,
    status: 'past',
    coverImage: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=1200&h=600&fit=crop',
    gallery: [
      { url: 'https://images.unsplash.com/photo-1462331940025-496dfbfc7564?w=800', alt: 'Galaxy Photo' },
      { url: 'https://images.unsplash.com/photo-1419242902214-272b3f66ee7a?w=800', alt: 'Milky Way' },
      { url: 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=800', alt: 'Nebula' }
    ],
    details: {
          ...
          <div className="relative bg-slate-900 rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto border border-slate-700 shadow-2xl">
            ...
            <div className="p-8">
                ...
                {event.attendees && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">{event.attendees} People</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="mb-8">
                ...
                {event.details.registrationLink && event.status === 'upcoming' && (
                  <a
    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {featuredEvent && (
          <div className="mb-16">
            ...
            <div
              ...
              className="group relative rounded-2xl overflow-hidden cursor-pointer border border-slate-800 hover:border-blue-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20"
            >
        ...
        {upcomingEvents.filter(e => !e.featured).length > 0 && (
          <div className="mb-16">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-1 h-8 bg-gradient-to-b from-green-500 to-blue-600 rounded-full" />
        ...
        <div>
          <div className="flex items-center gap-2 mb-6">
            <div className="w-1 h-8 bg-gradient-to-b from-slate-500 to-slate-700 rounded-full" />
